...
!**s/r wil_uvcase3 - To setup Williamson Case 3: Unsteady solid-body rotation (WINDS)

      subroutine wil_uvcase3_analy(F_u,F_v,F_minx,F_maxx,F_miny,F_maxy,F_nk,F_stag_L,step_dt_out)
...
#include <arch_specific.hf>
      ...
      real(kind=REAL64), intent(in) :: step_dt_out
      ...
      !object
      !================================================================================
      !     To setup Williamson Case 3: Unsteady solid-body rotation (WINDS)
      ...
      real(kind=REAL64)  ubar_8,sina_8,cosa_8,rlon_8,rlat_8,sint_8,cost_8, &
      ...
      if (Ptopo_couleur==0) then
         ...
         do j=g_j0,g_jn
            ...
            do i=g_i0,g_in
               ...
               uicll(i,j) = ubar_8*(sina_8*sint_8*(cosl_8*coso_8 - sinl_8*sino_8) + cosa_8*cost_8)
      ...
      !------------------------
         ...
         do j=g_j0,g_jn
            ...
            do i=g_i0,g_in
               ...
               ui_u_8(i,j) = ubar_8*(sina_8*sint_8*(cosl_8*coso_8 - sinl_8*sino_8) + cosa_8*cost_8)
               vi_u_8(i,j) = -ubar_8*sina_8*(sinl_8*coso_8 + cosl_8*sino_8) 
      ...
      if (Ptopo_couleur==0) then
         ...
         do j=g_j0,g_jn
            ...
            do i=g_i0,g_in
               ...
               vicll(i,j) = -ubar_8*sina_8*(sinl_8*coso_8 + cosl_8*sino_8) 
      ...
      !------------------------
         ...
         do j=g_j0,g_jn
            ...
            do i=g_i0,g_in
               ...
               ui_v_8(i,j) = ubar_8*(sina_8*sint_8*(cosl_8*coso_8 - sinl_8*sino_8) + cosa_8*cost_8) 
               vi_v_8(i,j) = -ubar_8*sina_8*(sinl_8*coso_8 + cosl_8*sino_8) 
