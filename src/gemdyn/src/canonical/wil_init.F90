...
!
      ...
      if (Williamson_case==1) then
         ...
         if (Williamson_Nair==0.or.Williamson_Nair==3) then
            ...
            qt0(i0:in,j0:jn,1:Nk)   = q1(i0:in,j0:jn,1:Nk)
            qt1(i0:in,j0:jn,1:Nk)   = q1(i0:in,j0:jn,1:Nk)
            qt2(i0:in,j0:jn,1:Nk)   = q1(i0:in,j0:jn,1:Nk)
      ...
      do k=1,G_nk+1
         do j=j0,jn
            do i=i0,in
               ...
               F_q(i,j,k) = F_gz(i,j,1) - Ver_z_8%m(1)
            end do
         end do
      end do
!
