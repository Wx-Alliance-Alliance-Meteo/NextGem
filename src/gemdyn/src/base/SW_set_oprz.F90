...
!     ~~~~~~~~~~~~~~~~~~~~~~
      ...
      Opr_opszp2_8(BB+k0)    =0.d0
      Opr_opszp2_8(CC+k0)    =0.d0
      do k = k0+1, G_nk-1
         Opr_opszp2_8(AA+k) =0.d0
         Opr_opszp2_8(BB+k) =0.d0
         Opr_opszp2_8(CC+k) =0.d0
      end do
      Opr_opszp2_8(AA+G_nk) = 0.d0
      Opr_opszp2_8(BB+G_nk) = 0.d0
...
!     ~~~~~~~~~~~~~~~~~~~~~~
      ...
      Opr_opszpl_8(BB+k0)    = 0.d0
      Opr_opszpl_8(CC+k0)    = 0.d0
      do k = k0+1, G_nk-1
         Opr_opszpl_8(AA+k) = 0.d0
         Opr_opszpl_8(BB+k) = 0.d0
         Opr_opszpl_8(CC+k) = 0.d0
      end do
      Opr_opszpl_8(AA+G_nk) = 0.d0
      Opr_opszpl_8(BB+G_nk) = 0.d0
...
!
      ...
      Opr_opszpm_8(BB+k0)    = -gg_sw_8
      Opr_opszpm_8(CC+k0)    = 0.d0
      do k = k0+1, G_nk-1
         Opr_opszpm_8(AA+k) = 0.d0
         Opr_opszpm_8(BB+k) = -gg_sw_8
         Opr_opszpm_8(CC+k) = 0.d0
      end do
      Opr_opszpm_8(AA+G_nk) = 0.d0
      Opr_opszpm_8(BB+G_nk) = -gg_sw_8
      Opr_opszpm_8(CC+G_nk) = 0.d0
      if (Schm_opentop_L) then
         Opr_opszpm_8(BB+k0) = 0.d0
      end if

!     ---------------------------------------------------
!     Compute eigenvalues and eigenvector in the vertical
!     ---------------------------------------------------
      call preverln ( r_8, bl_8, br_8, G_nk, G_nk)
!
