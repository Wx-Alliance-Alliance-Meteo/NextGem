...
subroutine nest_init_weight (F_weight,F_si,F_sj,F_sk,Minx,Maxx,Miny,Maxy,Nk)
  ...
  integer w1,w2,e1,e2,s1,s2,n1,n2,t1,t2,zlist
  ...
  real wk1(l_minx:G_ni+G_halox,l_miny:G_nj+G_haloy)
...
!!!!TODO: remove this section when BCs treatment re-formulated
  call glbcolc2(wk1,l_minx,G_ni+G_halox,l_miny,G_nj+G_haloy,1,1,&
                F_weight,l_minx,l_maxx,l_miny,l_maxy,1)
  ...
  zlist= -1
  if (Ptopo_myproc==0) zlist= 1
  call glbdist_os (wk1, F_weight,l_minx,l_maxx,l_miny,l_maxy, 1,&
                   G_ni+G_halox,G_nj+G_haloy,zlist,1,1.d0,0.d0)
!!!!
