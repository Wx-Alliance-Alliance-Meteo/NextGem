...
!                             (Based on tricublin_beta.c): Positions in Index space
      ...
      subroutine bicubHQV_lin_min_max_ntr (F_qut, F_lin, F_min, F_max, F_in, F_xyz, F_num, &
                                           F_minx, F_maxx, F_miny, F_maxy,F_ns,F_nptr)
      use adz_mem
      ...
      integer, intent(in) :: F_num,F_minx,F_maxx,F_miny,F_maxy,F_ns,F_nptr
...
!
      ...
      do n=1,F_num
         ...
         zqutic_L = (kk1 >= 3) .and.  (kk1 <= l_nk-3)
         zcubic_L =((kk1 == 2) .or.   (kk1 == l_nk-2))
...
contains
      ...
      end subroutine bicubHQV_lin_min_max_ntr
