...
!---------------------------------- LICENCE END -------------------------------
       ...
       subroutine itf_dfilter(F_iname,F_oname,F_nk)
...
#include <rmnlib_basics.hf>
      ...
      call gem_xch_halo ( ifld,l_minx,l_maxx,l_miny,l_maxy,F_nk,-1 )
      ...
      if(F_np==2) then
         ...
         ! Exchange halos
         call gem_xch_halo ( F_ofld,l_minx,l_maxx,l_miny,l_maxy,F_nk,-1 )
