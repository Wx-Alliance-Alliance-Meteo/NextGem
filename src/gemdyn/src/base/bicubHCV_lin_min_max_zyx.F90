...
!                                 (Based on tricublin_beta.c): Interpolation ZYX
      ...
      real(kind=REAL64), dimension(0:5), intent(in) :: cx,cy
      ...
      real(kind=REAL64), dimension(0:5) :: vx4, va4, vb4, vc4, vd4, ve4
      real, dimension(0:5) :: dst,dsl
      real :: mi_,ma_
!
!---------------------------------------------------------------------
!
      ...
      if (zcubic_L) then
       ...
       do i = 0,5
        ...
        do i = 0,5
         ...
         vx4(i) = src(i    )*qz(2) + src(i    +ninj)*qz(3) 
         va4(i) = src(i+ni )*qz(2) + src(i+ni +ninj)*qz(3)
         vb4(i) = src(i+ni2)*qz(2) + src(i+ni2+ninj)*qz(3)
         vc4(i) = src(i+ni3)*qz(2) + src(i+ni3+ninj)*qz(3)
         vd4(i) = src(i+ni4)*qz(2) + src(i+ni4+ninj)*qz(3)
         ve4(i) = src(i+ni5)*qz(2) + src(i+ni5+ninj)*qz(3)
