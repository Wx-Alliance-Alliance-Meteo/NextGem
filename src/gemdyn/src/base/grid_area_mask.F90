...
!**s/r grid_area_mask - Evaluate area and mask
      ...
      integer :: i,j,n,r_j1,r_j2,r_i1,r_i2,r_ish,r_jsh,i_north,j_north, &
                 i_middle,j_middle,err,i1,j1,i2,j2,i_sh,j_sh,comm,offi,offj
         ...
         do while (between_L)
            ...
            !---------------------------------------------------------------------------
               ...
               !-------------------------------------------------
                  ...
                  call gem_error (-1,'grid_area_mask',&
                                  'BOUNDARY: We are lost')
   ...
   L2:do j = j_north,j_north
      ...
      do j = 1+pil_s,l_nj-pil_n
         ...
         do i = 1+pil_w,l_ni-pil_e
            ...
            l_mask_8(i,j) = max(0.d0,min(1.d0,g_mask_8(i+offi,j+offj)))
