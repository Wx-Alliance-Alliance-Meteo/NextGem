...
!     p_zexabcd_8 => Adz_zexabcd_8%t
      ...
      do n=1,F_num
         ...
         px(0) = 0.d0
         px(1) = del*(del-1.d0)*(del-2.d0)*cm167
         px(2) = (del+1.d0)*(del-1.d0)*(del-2.d0)*cp5
         px(3) = del*(del+1.d0)*(del-2.d0)*cm5
         px(4) = del*(del+1.d0)*(del-1.d0)*cp167
         px(5) = 0.d0
         ...
         py(0) = 0.d0
         py(1) = del*(del-1.d0)*(del-2.d0)*cm167
         py(2) = (del+1.d0)*(del-1.d0)*(del-2.d0)*cp5
         py(3) = del*(del+1.d0)*(del-2.d0)*cm5
         py(4) = del*(del+1.d0)*(del-1.d0)*cp167
         py(5) = 0.d0
