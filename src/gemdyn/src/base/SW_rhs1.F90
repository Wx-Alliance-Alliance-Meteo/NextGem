...
!I will just set them to 0            
      ...
      do n= HLT_start, HLT_end
         ...
         do i= 1, l_ni
            ...
            orhsw_ext(i,j,k)  = Cstv_swln_8*log(Cstv_h0inv_8*(qt1(i,j,k)-fis0(i,j)/grav_8)+1.d0)+(1.-Cstv_swln_8)*(Cstv_h0inv_8*(qt1(i,j,k)-fis0(i,j)/grav_8))
            orhst_ext(i,j,k)  = ut2(i,j,k)
            orhsc_ext(i,j,k)  = vt2(i,j,k)
            orhsf_ext(i,j,k)  = Cstv_swln_8*log(Cstv_h0inv_8*(qt2(i,j,k)-fis0(i,j)/grav_8)+1.d0)+(1.-Cstv_swln_8)*(Cstv_h0inv_8*(qt2(i,j,k)-fis0(i,j)/grav_8))
