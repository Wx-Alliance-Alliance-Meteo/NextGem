...
!
      ...
      integer :: i, j,k
      integer :: istat, nch2d,  mmax, latmax
!-------------------------------------------------------------------
!
      ...
      istat = gmm_get(gmmk_mcsph1_s,mcsph1)
      ...
      istat = gmm_get(gmmk_ensdiv_s,ensdiv)
      istat = gmm_get(gmmk_ensvor_s,ensvor)
      ...
      istat = gmm_get(gmmk_ar_s   ,ar_s)
      istat = gmm_get(gmmk_br_s   ,br_s)
      istat = gmm_get(gmmk_ai_s   ,ai_s)
      istat = gmm_get(gmmk_bi_s   ,bi_s)
      istat = gmm_get(gmmk_ar_p   ,ar_p)
      istat = gmm_get(gmmk_br_p   ,br_p)
      istat = gmm_get(gmmk_ai_p   ,ai_p)
      istat = gmm_get(gmmk_bi_p   ,bi_p)
      ...
      istat = gmm_get(gmmk_pls_s,pls)
      istat = gmm_get(gmmk_plp_s,plp)
      istat = gmm_get(gmmk_dumdum_s,dumdum)


      call ens_markov_spp_init() 
      call ens_markov_skeb_init() 
