...
!---------------------------------- LICENCE END ---------------------------------
      ...
      real, pointer, contiguous, dimension (:) :: pwPLUS  => null()
      real, pointer, contiguous, dimension (:) :: pwMOINS => null()
      ...
      type(gmm_contiguous_pntrs), allocatable :: pw_pnt_P(:)
      type(gmm_contiguous_pntrs), allocatable :: pw_pnt_M(:)
