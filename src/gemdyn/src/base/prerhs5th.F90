...
!**s/r tt2wnd - Pre-compute stuff for elliptic_rhs
      ...
      subroutine prerhs5th ( F_t2u, F_v2u, F_t2v, F_u2v, &
...
!
      do k=1, l_nk
         ...
         do j= 1, l_nj
           do i= 1, l_ni
             do n=-2,3
               t2qv(n) = tt0(i+n,j,km3) * QWt2m(1,k) + tt0(i+n,j,km2) * QWt2m(2,k)&
               ...
               t2qu(n) = tt0(i,j+n,km3) * QWt2m(1,k) + tt0(i,j+n,km2) * QWt2m(2,k)&
