...
! only in the context of ADZ_OD_L=.false.
      ...
      real, pointer, dimension (:,:,:  ) :: Adz_uu_ext,Adz_vv_ext,Adz_ww_ext,&
                              Adz_uu_dep_ext, Adz_vv_dep_ext, Adz_ww_dep_ext
      real, pointer, dimension (:      ), contiguous :: Adz_winds_ext    =>null()
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
! Adz_pxyzm and Adz_wpxyz are a history carrying variables: must be part of the restart
      ...
      real(kind=REAL64), pointer, dimension (:,:,:) :: Adz_wpz=>null()
      real(kind=REAL64), pointer, dimension (:,:,:) :: Adz_dpz=>null()

      !---new added arrays for bdf---
      !1. holds alpha/displacement for trajectories; stnrd. 3-time-level scheme
      real(kind=REAL64), pointer, dimension (:,:,:,:) :: Adz_disp=>null() 
      ...
      real, allocatable, dimension (:,:,:,:) ::  Adz_uvw_d, Adz_uvw_d_dep !added for departure
