...
!**s/r elliptic_rhs - Compute right hand side of the elliptic problem
      ...
      subroutine elliptic_rhs2nd ( F_dt_8, k0, k0t )
      ...
      integer :: km1,i00,inn,j00,jnn,dim,ub
...
!
      ...
      call prerhs2nd (t2u, v2u, t2v, u2v, dqz2u, dqz2v, dqz2w,&
...
!
      return
      end subroutine elliptic_rhs2nd
