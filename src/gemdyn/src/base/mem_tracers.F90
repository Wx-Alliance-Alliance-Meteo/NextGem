...
module mem_tracers
   ...
   save
      ...
      real, pointer, contiguous, dimension (:) :: trt2 => null()
      real, pointer, contiguous, dimension (:) :: trt1 => null()
      real, pointer, contiguous, dimension (:) :: trt0 => null()
      real, pointer, contiguous, dimension (:) :: trdf => null()
      real, pointer, contiguous, dimension (:) :: trtb => null()
      real(kind=REAL64), dimension (:,:,:), pointer :: sumq_8
      real             , dimension (:,:,:), pointer :: air_mass, w_tr
